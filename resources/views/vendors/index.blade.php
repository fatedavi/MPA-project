                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900">{{ $vendors->unique('kota')->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($vendors as $vendor)
                                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="w-10 h-10 bg-gradient-to-r from-green-500 to-green-600 rounded-lg flex items-center justify-center mr-3">
                                                    <span class="text-white text-sm font-semibold">{{ substr($vendor->nama_vendor, 0, 1) }}</span>
                                                </div>
                                                <div>
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="text-sm text-gray-900 max-w-xs truncate" title="{{ $vendor->alamat_vendor }}">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                <a href="tel:{{ $vendor->no_telp }}" class="ml-2 text-blue-600 hover:text-blue-800" title="Call vendor">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                <a href="mailto:{{ $vendor->email_vendor }}" class="ml-2 text-blue-600 hover:text-blue-800" title="Send email">
                                    ...
                                    <tr>
                                        <td colspan="8" class="px-6 py-12 text-center">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <p class="text-gray-500 mb-4">Get started by creating your first vendor.</p>
                                                <a href="{{ route('vendors.create') }}" class="inline-flex items-center px-4 py-2 bg-[#8D0907] border border-transparent rounded-md font-semibold text-sm text-white hover:bg-[#B91C1C] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8D0907] transition-colors">
                                                    <i class="fas fa-plus mr-2"></i>
                                                    Add First Vendor
                                                </a>
                                            </div>
