                ...
                <form method="POST" action="{{ route('vendors.update', $vendor->id_vendor) }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="nama_vendor" id="nama_vendor" value="{{ $vendor->nama_vendor }}"
                                required class="mt-1 block w-full border-gray-300 rounded-md">
                        </div>
                        <div>
                            <label for="up_vendor" class="block text-sm font-medium text-gray-700">UP Vendor *</label>
                            <input type="text" name="up_vendor" id="up_vendor" value="{{ $vendor->up_vendor }}"
                                required class="mt-1 block w-full border-gray-300 rounded-md">
                        </div>
                        <div>
                            <label for="no_telp" class="block text-sm font-medium text-gray-700">No Telp *</label>
                            <input type="number" name="no_telp" id="no_telp" value="{{ $vendor->no_telp }}" required
                        ...
                        <div>
                            ...
                            <input type="email" name="email_vendor" id="email_vendor"
                                value="{{ $vendor->email_vendor }}" required
                                class="mt-1 block w-full border-gray-300 rounded-md">
                        </div>
                        <div>
                            <label for="kota" class="block text-sm font-medium text-gray-700">Kota *</label>
                            <input type="text" name="kota" id="kota" value="{{ $vendor->kota }}" required
                                class="mt-1 block w-full border-gray-300 rounded-md">
                        </div>
                        <div class="md:col-span-2">
                            ...
                            <textarea name="alamat_vendor" id="alamat_vendor" rows="3" required
                                class="mt-1 block w-full border-gray-300 rounded-md">{{ $vendor->alamat_vendor }}</textarea>
                        </div>
                    </div>
