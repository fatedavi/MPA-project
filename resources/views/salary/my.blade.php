    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-[#8D0907] to-[#B91C1C] rounded-lg shadow-lg p-6 text-white mb-6">
                <div class="flex items-center">
                    <div
                        class="w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center text-2xl font-bold">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-xl font-bold">Rp
                                {{ number_format($salaries->sum('total_bonus'), 0, ',', '.') }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-lg p-6 text-white">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-xl font-bold">Rp
                                {{ number_format($salaries->sum('total_event_reward'), 0, ',', '.') }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-red-500 to-red-600 rounded-lg shadow-lg p-6 text-white">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-xl font-bold">Rp
                                {{ number_format($salaries->sum('potongan_cuti'), 0, ',', '.') }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg shadow-lg p-6 text-white">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-xl font-bold">Rp
                                {{ number_format($salaries->sum('total_salary'), 0, ',', '.') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow-sm rounded-lg border border-gray-200">
                ...
                <div class="p-6">
                                ...
                                @forelse ($salaries as $salary)
                                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                                        <td class="px-6 py-4">
                                            <div class="flex items-center">
                                                <div
                                                    class="w-10 h-10 bg-gradient-to-r from-[#8D0907] to-[#B91C1C] rounded-full flex items-center justify-center text-white font-semibold text-sm">
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <div
                                                class="text-lg font-bold text-green-700 bg-green-50 px-3 py-1 rounded-lg inline-block">
                    ...
                    @if ($salaries->count() > 0)
                        <div
                            class="mt-6 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-6 border border-gray-200">
