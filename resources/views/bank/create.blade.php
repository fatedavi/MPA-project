                ...
                <nav class="flex" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            <div class="flex items-center">
                                <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
                                <span class="text-sm font-medium text-gray-500">Add New Bank</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="nama_bank" id="nama_bank" value="{{ old('nama_bank') }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-[#8D0907] focus:border-[#8D0907] sm:text-sm" placeholder="e.g., Bank Mandiri, BCA, BNI">
                                    @error('nama_bank')
                                ...
                                <div>
                                    ...
                                    <input type="text" name="an" id="an" value="{{ old('an') }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-[#8D0907] focus:border-[#8D0907] sm:text-sm" placeholder="e.g., PT. Company Name">
                                    @error('an')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="ac" id="ac" value="{{ old('ac') }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-[#8D0907] focus:border-[#8D0907] sm:text-sm font-mono" placeholder="e.g., 1234567890">
                                    @error('ac')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
