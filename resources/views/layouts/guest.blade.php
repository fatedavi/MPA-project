...
<body class="font-sans text-gray-900 antialiased">
    <div
        class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-100">
        <!-- Logo/Header -->
        ...
        <!-- Card Container -->
        <div
            class="w-full sm:max-w-md mt-6 px-6 py-8 bg-white shadow-lg overflow-hidden sm:rounded-lg backdrop-blur-sm bg-white/70 border border-white/20">
            {{ $slot }}
        </div>
