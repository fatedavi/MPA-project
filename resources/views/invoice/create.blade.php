                ...
                <div class="p-6">
                        ...
                        <div class="mb-6 bg-red-50 border border-red-200 rounded-lg p-4">
                            <div class="flex">
                                <div class="flex-shrink-0">
                                    <svg class="h-5 w-5 text-red-400" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd"
                                            d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.586 9L9.293 8.293a1 1 0 00-1.414-1.414L8 8.586 6.707 7.293a1 1 0 00-1.414 1.414L6.586 10l-1.293 1.293a1 1 0 101.414 1.414L8 11.414l1.293 1.293a1 1 0 001.414-1.414L9.414 10l1.293-1.293a1 1 0 00-1.414-1.414L8 8.586z"
                                            clip-rule="evenodd" />
                                    </svg>
                                </div>
                                <div class="ml-3">
                    ...
                    <form method="POST" action="{{ route('invoice.store') }}" class="space-y-8"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="no_invoice" id="no_invoice"
                                        ...
                                        placeholder="MPA000/INV/d-m-Y" readonly>
                                    <p class="mt-1 text-xs text-gray-500">Invoice number will be auto-generated
                                        (MPA000/INV/d-m-Y)</p>
                                </div>
                                ...
                                <div>
                                    <label for="tgl_invoice" class="block text-sm font-medium text-gray-700">Invoice
                                        Date *</label>
                                    <input type="date" name="tgl_invoice" id="tgl_invoice" required
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-[#8D0907] focus:border-[#8D0907] sm:text-sm">
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                            <div>
                                                ...
                                                <input type="number" name="detail_invoice[0][qty]" min="0.01"
                                                    step="0.01" required
                                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-[#8D0907] focus:border-[#8D0907] sm:text-sm"
                                            ...
                                            <div>
                                                ...
                                                <input type="number" name="detail_invoice[0][harga]" min="0"
                                                    step="0.01" required
                                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-[#8D0907] focus:border-[#8D0907] sm:text-sm"
                                    ...
                                    <select name="nama_bank" id="nama_bank" required
                                        ...
                                        @foreach ($banks as $bank)
                                            <option value="{{ $bank->nama_bank }}" data-an="{{ $bank->an }}"
                                                data-ac="{{ $bank->ac }}">{{ $bank->nama_bank }}</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        {{-- <div class="bg-rose-50 border border-rose-200 rounded-lg p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="flex items-center">
                                    <input type="checkbox" name="ttd" id="ttd" value="1"
                                        class="h-4 w-4 text-[#8D0907] focus:ring-[#8D0907] border-gray-300 rounded">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="ttdkwitansi" id="ttdkwitansi" value="1"
                                        class="h-4 w-4 text-[#8D0907] focus:ring-[#8D0907] border-gray-300 rounded">
                                    <label for="ttdkwitansi" id="ttdkwitansi"
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="ttdbast" id="ttdbast" value="1"
                                        class="h-4 w-4 text-[#8D0907] focus:ring-[#8D0907] border-gray-300 rounded">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="ttdbakn" id="ttdbakn" value="1"
                                        class="h-4 w-4 text-[#8D0907] focus:ring-[#8D0907] border-gray-300 rounded">
