                ...
                <div class="p-6">
                    ...
                    <div class="flex flex-wrap gap-3 mb-6">
                        ...
                        <select
                            ...
                            @foreach ($invoices->pluck('jenis_no')->unique()->filter() as $jenis)
                                <option>{{ $jenis }}</option>
                            @endforeach
                        </select>
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="text-sm text-gray-900 max-w-xs">
                                                <div class="font-medium truncate" title="{{ $invoice->uraian }}">
                                                    {{ Str::limit($invoice->uraian, 30) }}
                                                </div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900">
                                                IDR {{ number_format($invoice->harga, 0, ',', '.') }}
                                            </div>
