                ...
                <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg shadow-lg p-6 text-white">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold">IDR {{ number_format($invoices->sum('total_invoice'), 0, ',', '.') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow-sm rounded-lg border border-gray-200">
                ...
                <div class="p-6">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" placeholder="Search invoices..." class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#8D0907] focus:border-[#8D0907] transition-colors">
                            </div>
                            
                            <!-- Add Invoice Button -->
                            <a href="{{ route('invoice.create') }}" class="inline-flex items-center px-6 py-2 bg-[#8D0907] text-white rounded-lg hover:bg-[#6B0705] transition-colors shadow-md hover:shadow-lg">
                    ...
                    <div class="flex flex-wrap gap-3 mb-6">
                        <select class="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#8D0907] focus:border-[#8D0907] transition-colors">
                        ...
                        <input type="date" class="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#8D0907] focus:border-[#8D0907] transition-colors">
                        
                        <button class="px-4 py-2 bg-gray-100 border border-gray-300 rounded-lg text-sm text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-[#8D0907] focus:border-[#8D0907] transition-colors">
                            Reset Filters
                        </button>
                    </div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                ...
                                                <div class="text-sm text-gray-500 max-w-xs truncate" title="{{ $invoice->deskripsi ?? 'No description' }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        @if($invoice->status === 'paid' && $invoice->tgl_paid)
                                            <div class="text-sm text-green-600">
                                                ...
                                                Paid on {{ \Carbon\Carbon::parse($invoice->tgl_paid)->format('M d, Y') }}
                                            </div>
