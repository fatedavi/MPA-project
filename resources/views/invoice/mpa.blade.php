            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" placeholder="Search invoices..."
                                    class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-[#8D0907] focus:border-[#8D0907] sm:text-sm">
                            </div>
                    ...
                    <div class="flex flex-wrap gap-3 mb-6">
                        <select
                            class="px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-[#8D0907] focus:border-[#8D0907]">
                        ...
                        <button
                            class="px-4 py-2 bg-gray-100 border border-gray-300 rounded-md text-sm text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-1 focus:ring-[#8D0907] focus:border-[#8D0907]">
                            Reset Filters
                        </button>
                    </div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <div
                                                    class="h-10 w-10 rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 flex items-center justify-center text-white font-semibold">
                                                    INV
                                                </div>
                                            </div>
                                            <div class="ml-4">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <div
                                                    class="h-10 w-10 rounded-lg bg-gradient-to-r from-yellow-500 to-yellow-600 flex items-center justify-center text-white font-semibold">
                                                    INV
                                                </div>
                                            </div>
                                            <div class="ml-4">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <div
                                                    class="h-10 w-10 rounded-lg bg-gradient-to-r from-red-500 to-red-600 flex items-center justify-center text-white font-semibold">
                                                    INV
                                                </div>
                                            </div>
                                            <div class="ml-4">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <span
                                class="px-3 py-2 text-sm font-medium text-gray-700 bg-[#8D0907] text-white border border-[#8D0907] rounded-md">1</span>
                            <button
