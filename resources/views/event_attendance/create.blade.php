    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-4">
                ...
                <select name="employee_id[]" id="employee_id" class="mt-1 block w-full border border-gray-300 rounded-md" multiple>
                ...
                <p class="text-sm text-gray-500">Tekan CTRL / CMD untuk memilih lebih dari 1 pegawai</p>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="event_id" id="event_id" class="mt-1 block w-full border border-gray-300 rounded-md">
