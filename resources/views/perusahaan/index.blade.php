                ...
                <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-lg shadow-lg p-6 text-white">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold">{{ $perusahaan->getCollection()->unique('kota')->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg shadow-lg p-6 text-white">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold">{{ $perusahaan->getCollection()->unique('pemilik')->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg shadow-lg p-6 text-white">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold">{{ $perusahaan->getCollection()->whereNotNull('email')->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="w-12 h-12 bg-gradient-to-r from-[#8D0907] to-[#B91C1C] rounded-lg flex items-center justify-center text-white font-semibold text-lg">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="ml-3">
                                                ...
                                                <div class="text-sm text-gray-500 max-w-xs truncate" title="{{ $per->alamat }}">
                                    ...
                                    <td class="px-6 py-4">
                                        @if($per->email)
                                            <a href="mailto:{{ $per->email }}" class="text-sm text-blue-600 hover:text-blue-800 flex items-center">
